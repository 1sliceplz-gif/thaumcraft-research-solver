# aspects.py
# GTNH Thaumcraft Aspect Definitions
...
def get_children(aspect):
    """Return all aspects that have this aspect as a parent."""
    return {asp for asp, parents in aspect_parents.items() if aspect in parents}


def get_all_connections(aspect):
    """Return all aspects directly connected (parents + children)."""
...
def validate_aspects():
    """Check for issues in aspect definitions."""
    issues = []
